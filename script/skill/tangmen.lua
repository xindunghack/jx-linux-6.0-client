...
SKILLS={
	...
	shehun_yueying={ --摄魂月影
		physicsenhance_p={{{1,25},{15,50},{20,101}}},
	...
	baoyu_lihua={ --暴雨梨花
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,15},{15,100},{20,234}}},
	...
	jiugong_feixing={ --九宫飞星
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,10},{15,50},{20,194}}},
